...
class NoteShapeUtil extends import_editor.ShapeUtil {
  ...
  component(shape) {
    ...
    let hideShadows = (0, import_useEfficientZoomThreshold.useEfficientZoomThreshold)(0.25 / scale);
  ...
  getIndicatorPath(shape) {
    ...
    path.roundRect(0, 0, import_noteHelpers.NOTE_SIZE * scale, getNoteHeight(shape), scale);
    return path;
  }
  toSvg(shape, ctx) {
