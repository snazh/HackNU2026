...
function TldrawUiDropdownMenuSubTrigger({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.DropdownMenu.SubTrigger, { dir: "ltr", asChild: true, disabled, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
...
function TldrawUiDropdownMenuGroup({ className, children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { dir: "ltr", className: (0, import_classnames.default)("tlui-menu__group", className), children });
}
function TldrawUiDropdownMenuIndicator() {
  const msg = (0, import_useTranslation.useTranslation)();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.DropdownMenu.ItemIndicator, { dir: "ltr", asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiIcon.TldrawUiIcon, { label: msg("ui.checked"), icon: "check" }) });
}
function TldrawUiDropdownMenuItem({ noClose, children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.DropdownMenu.Item, { dir: "ltr", asChild: true, onClick: noClose ? import_editor.preventDefault : void 0, children });
}
function TldrawUiDropdownMenuCheckboxItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    import_radix_ui.DropdownMenu.CheckboxItem,
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "tlui-button__checkbox__indicator", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_radix_ui.DropdownMenu.ItemIndicator, { dir: "ltr", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_TldrawUiIcon.TldrawUiIcon, { label: msg("ui.checked"), icon: "check", small: true }) }) }),
        children
      ]
    }
  );
