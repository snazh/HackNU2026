...
function TldrawUiPopover({ id, children, onOpenChange, open, className }) {
  ...
  return /* @__PURE__ */ jsx(_Popover.Root, { onOpenChange: handleOpenChange, open: open || isOpen, children: /* @__PURE__ */ jsx("div", { className: classNames("tlui-popover", className), children }) });
}
