...
function LiveblocksUiConfig({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(LiveblocksUiConfigContext.Provider, { value: liveblocksUiConfig, children: /* @__PURE__ */ jsxRuntime.jsx(overrides.OverridesProvider, { overrides: overrides$1, children: /* @__PURE__ */ jsxRuntime.jsx(components.ComponentsProvider, { components: components$1, children }) }) });
}
