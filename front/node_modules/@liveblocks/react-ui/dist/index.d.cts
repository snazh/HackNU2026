...
import { ComponentType, ComponentPropsWithoutRef, ElementType, ReactNode, ComponentProps, FormEvent, RefAttributes, PropsWithChildren, MouseEvent } from 'react';
...
type ComposerCreateThreadProps<TM extends BaseMetadata, CM extends BaseMetadata> = {
    threadId?: never;
    commentId?: never;
    /**
...
type ComposerProps<TM extends BaseMetadata = DTM, CM extends BaseMetadata = DCM> = Omit<ComponentPropsWithoutRef<"form">, "defaultValue"> & (ComposerCreateThreadProps<TM, CM> | ComposerCreateCommentProps<CM> | ComposerEditCommentProps<CM>) & {
    /**
     * The event handler called when the composer is submitted.
     */
    onComposerSubmit?: (comment: ComposerSubmitComment, event: FormEvent<HTMLFormElement>) => Promise<void> | void;
...
interface CommentProps<CM extends BaseMetadata = DCM> extends Omit<ComponentPropsWithoutRef<"div">, "children"> {
     ...
     */
    body?: ReactNode | ((props: PropsWithChildren<{
        comment: CommentData<CM>;
    }>) => ReactNode);
    /**
