...
const defaultComponents = {
  ...
  Inline: ({ type, children }) => {
    switch (type) {
      ...
      case "em":
        return /* @__PURE__ */ jsx("em", { children });
      case "code":
        return /* @__PURE__ */ jsx("code", { children });
      case "del":
        return /* @__PURE__ */ jsx("del", { children });
      default:
        assertNever(type, "Unknown inline type");
    }
  },
  CodeBlock: ({ language, code }) => {
    return /* @__PURE__ */ jsx("pre", { "data-language": language ?? void 0, children: /* @__PURE__ */ jsx("code", { children: code }) });
  },
  Link: ({ href, title, children }) => {
    return /* @__PURE__ */ jsx("a", { href, title, target: "_blank", rel: "noopener noreferrer", children });
  },
  Heading: ({ level, children }) => {
    const Heading = `h${level}`;
    return /* @__PURE__ */ jsx(Heading, { children });
  },
  Image: ({ src, alt, title }) => {
    return /* @__PURE__ */ jsx("img", { src, alt, title });
  },
  Blockquote: ({ children }) => {
    return /* @__PURE__ */ jsx("blockquote", { children });
  },
  Table: ({ headings, rows }) => {
    return /* @__PURE__ */ jsxs("table", { children: [
      /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { children: headings.map((heading, index) => {
        return /* @__PURE__ */ jsx("th", { align: heading.align, children: heading.children }, index);
      }) }) }),
      /* @__PURE__ */ jsx("tbody", { children: rows.map((row, index) => {
        return /* @__PURE__ */ jsx("tr", { children: row.map((cell, index2) => {
          return /* @__PURE__ */ jsx("td", { align: cell.align, children: cell.children }, index2);
        }) }, index);
      }) })
    ] });
  },
  List: ({ type, items, start }) => {
    ...
    return /* @__PURE__ */ jsx(List, { start: start === 1 ? void 0 : start, children: items.map((item, index) => /* @__PURE__ */ jsx("li", { children: item.children }, index)) });
  },
  Separator: () => {
...
const Markdown = forwardRef(
  ({ content, partial, components, asChild, ...props }, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx(Component, { ...props, ref: forwardedRef, children: tokens.map((token, index) => {
      return /* @__PURE__ */ jsx(
...
const MemoizedMarkdownToken = memo(
  ({
    ...
    return /* @__PURE__ */ jsx(MarkdownToken, { token, components });
  },
  ...
  switch (token.type) {
    ...
    case "text": {
      if (token.tokens !== void 0) {
        return /* @__PURE__ */ jsx(MarkdownTokens, { tokens: token.tokens, components });
      } else {
    ...
    case "heading": {
      ...
      return /* @__PURE__ */ jsx(Heading, { level: clampHeadingLevel(token.depth), children: /* @__PURE__ */ jsx(MarkdownTokens, { tokens: token.tokens, components }) });
    }
    case "strong": {
      const Inline = components?.Inline ?? defaultComponents.Inline;
      return /* @__PURE__ */ jsx(Inline, { type: "strong", children: /* @__PURE__ */ jsx(MarkdownTokens, { tokens: token.tokens, components }) });
    }
    case "em": {
      const Inline = components?.Inline ?? defaultComponents.Inline;
      return /* @__PURE__ */ jsx(Inline, { type: "em", children: /* @__PURE__ */ jsx(MarkdownTokens, { tokens: token.tokens, components }) });
    }
    case "codespan": {
      const Inline = components?.Inline ?? defaultComponents.Inline;
      return /* @__PURE__ */ jsx(Inline, { type: "code", children: parseHtmlEntities(token.text) });
    }
    case "del": {
      const Inline = components?.Inline ?? defaultComponents.Inline;
      return /* @__PURE__ */ jsx(Inline, { type: "del", children: /* @__PURE__ */ jsx(MarkdownTokens, { tokens: token.tokens, components }) });
    }
    case "link": {
      ...
      return /* @__PURE__ */ jsx(Link, { href, title: token.title ?? void 0, children: /* @__PURE__ */ jsx(MarkdownTokens, { tokens: token.tokens, components }) });
    }
    case "code": {
      let language = void 0;
      ...
      return /* @__PURE__ */ jsx(CodeBlock, { language, code: token.text || " " });
    }
    case "blockquote": {
      const Blockquote = components?.Blockquote ?? defaultComponents.Blockquote;
      return /* @__PURE__ */ jsx(Blockquote, { children: /* @__PURE__ */ jsx(
        MarkdownTokens,
        {
          tokens: token.tokens,
          components,
    ...
    case "checkbox": {
      return /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("input", { type: "checkbox", disabled: true, checked: token.checked }),
        " "
      ] });
    }
    case "table": {
      ...
      const headings = token.header.map(
        (cell) => ({
          ...
          children: /* @__PURE__ */ jsx(MarkdownTokens, { tokens: cell.tokens, components })
        })
      );
      ...
      return /* @__PURE__ */ jsx(Table, { headings, rows });
    }
    case "image": {
      const href = sanitizeUrl(token.href);
      if (href === null) {
      ...
      return /* @__PURE__ */ jsx(Image, { src: href, alt: token.text, title: token.title ?? void 0 });
    }
    case "hr": {
...
function MarkdownTokens({
  ...
  return normalizedTokens.map((token, index) => /* @__PURE__ */ jsx(MarkdownToken, { token, components }, index));
}
    ...
    if (partialLinkImageMatch) {
      ...
      if (!isInsideInlineCode) {
        ...
        if (isImage) {
          ...
          const completedLinkUrl = partialLinkUrl && !WHITESPACE_REGEX.test(partialLinkUrl) && isUrl(partialLinkUrl) ? (
