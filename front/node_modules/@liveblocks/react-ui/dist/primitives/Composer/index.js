...
function ComposerEditorMentionWrapper({
  ...
  return /* @__PURE__ */ jsxs("span", { ...attributes, children: [
    element.id ? /* @__PURE__ */ jsx(Mention, { mention, isSelected }) : null,
    children
  ] });
}
function ComposerEditorLinkWrapper({
  ...
  return /* @__PURE__ */ jsx("span", { ...attributes, children: /* @__PURE__ */ jsx(Link, { href, children }) });
}
function ComposerEditorMentionSuggestionsWrapper({
  ...
  return /* @__PURE__ */ jsx(Persist, { children: isOpen ? /* @__PURE__ */ jsx(
...
function ComposerEditorElement({
  ...
  switch (element.type) {
    ...
    case "paragraph":
      return /* @__PURE__ */ jsx("p", { ...attributes, style: { position: "relative" }, children });
    default:
      return null;
  }
}
...
const defaultEditorComponents = {
  Link: ({ href, children }) => {
    return /* @__PURE__ */ jsx(ComposerLink, { href, children });
  },
  Mention: ({ mention }) => {
    return /* @__PURE__ */ jsxs(ComposerMention, { children: [
      MENTION_CHARACTER,
      mention.id
    ] });
  },
  MentionSuggestions: ({ mentions }) => {
    return mentions.length > 0 ? /* @__PURE__ */ jsx(ComposerSuggestions, { children: /* @__PURE__ */ jsx(ComposerSuggestionsList, { children: mentions.map((mention) => /* @__PURE__ */ jsx(ComposerSuggestionsListItem, { value: mention.id, children: mention.id }, mention.id)) }) }) : null;
  }
};
const ComposerEditor = forwardRef(
  ({
    ...
    const renderElement = useCallback(
      (props2) => {
        return /* @__PURE__ */ jsx(ComposerEditorElement, { Mention, Link, ...props2 });
      },
      [Link, Mention]
    );
          ...
          ComposerAttachmentsContext.Provider,
          {
            ...
            children: /* @__PURE__ */ jsx(
              ComposerContext.Provider,
              {
                ...
                children: /* @__PURE__ */ jsxs(Component, { ...props, onSubmit: handleSubmit, ref: mergedRefs, children: [
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "file",
  ...
  ({
    ...
    return /* @__PURE__ */ jsx(
      Toggle.Root,
      {
        ...
        onPointerDown: handlePointerDown,
        ...props,
        children: /* @__PURE__ */ jsx(Component, { ...props, ref: forwardedRef, children })
      }
    );
  }
);
