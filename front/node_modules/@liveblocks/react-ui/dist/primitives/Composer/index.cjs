...
function ComposerEditorMentionWrapper({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("span", { ...attributes, children: [
    element.id ? /* @__PURE__ */ jsxRuntime.jsx(Mention, { mention, isSelected }) : null,
    children
  ] });
}
function ComposerEditorLinkWrapper({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("span", { ...attributes, children: /* @__PURE__ */ jsxRuntime.jsx(Link, { href, children }) });
}
function ComposerEditorMentionSuggestionsWrapper({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Persist.Persist, { children: isOpen ? /* @__PURE__ */ jsxRuntime.jsx(
    contexts.ComposerSuggestionsContext.Provider,
    {
      value: {
        id,
        itemId,
...
function ComposerEditorFloatingToolbarWrapper({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Persist.Persist, { children: isOpen ? /* @__PURE__ */ jsxRuntime.jsx(
    contexts.ComposerFloatingToolbarContext.Provider,
    {
      value: {
        id,
        placement,
...
function ComposerEditorElement({
  ...
  switch (element.type) {
    ...
    case "paragraph":
      return /* @__PURE__ */ jsxRuntime.jsx("p", { ...attributes, style: { position: "relative" }, children });
    default:
      return null;
  }
}
function ComposerEditorLeaf({
  ...
  if (leaf.bold) {
    children = /* @__PURE__ */ jsxRuntime.jsx("strong", { children });
  }
  if (leaf.italic) {
    children = /* @__PURE__ */ jsxRuntime.jsx("em", { children });
  }
  if (leaf.strikethrough) {
    children = /* @__PURE__ */ jsxRuntime.jsx("s", { children });
  }
  if (leaf.code) {
...
const defaultEditorComponents = {
  Link: ({ href, children }) => {
    return /* @__PURE__ */ jsxRuntime.jsx(ComposerLink, { href, children });
  },
  Mention: ({ mention }) => {
    return /* @__PURE__ */ jsxRuntime.jsxs(ComposerMention, { children: [
      core.MENTION_CHARACTER,
      mention.id
    ] });
  },
  MentionSuggestions: ({ mentions }) => {
    return mentions.length > 0 ? /* @__PURE__ */ jsxRuntime.jsx(ComposerSuggestions, { children: /* @__PURE__ */ jsxRuntime.jsx(ComposerSuggestionsList, { children: mentions.map((mention) => /* @__PURE__ */ jsxRuntime.jsx(ComposerSuggestionsListItem, { value: mention.id, children: mention.id }, mention.id)) }) }) : null;
  }
};
const ComposerEditor = react.forwardRef(
  ({
    ...
    const renderElement = react.useCallback(
      (props2) => {
        return /* @__PURE__ */ jsxRuntime.jsx(ComposerEditorElement, { Mention, Link, ...props2 });
      },
      [Link, Mention]
    );
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      slateReact.Slate,
      {
        ...
        children: [
          ...
          FloatingToolbar && /* @__PURE__ */ jsxRuntime.jsx(
...
const ComposerForm = react.forwardRef(
  ({
      ...
      (resetSelection = true) => {
        try {
          if (!slateReact.ReactEditor.isFocused(editor)) {
            ...
            if (editor.selection) {
              const domSelection = window.getSelection();
              const domRange = getDomRange.getDOMRange(editor, editor.selection);
              if (domRange) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      contexts.ComposerEditorContext.Provider,
      {
        value: {
          editor,
          validate,
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          contexts.ComposerAttachmentsContext.Provider,
          {
            value: {
              createAttachments,
              isUploadingAttachments,
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(
              contexts.ComposerContext.Provider,
              {
                value: {
                  isDisabled,
                  isFocused,
                ...
                children: /* @__PURE__ */ jsxRuntime.jsxs(Component, { ...props, onSubmit: handleSubmit, ref: mergedRefs, children: [
                  /* @__PURE__ */ jsxRuntime.jsx(
                    "input",
                    {
                      type: "file",
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      radixUi.Toggle.Root,
      {
        ...
        onPointerDown: handlePointerDown,
        ...props,
        children: /* @__PURE__ */ jsxRuntime.jsx(Component, { ...props, ref: forwardedRef, children })
      }
    );
  }
);
