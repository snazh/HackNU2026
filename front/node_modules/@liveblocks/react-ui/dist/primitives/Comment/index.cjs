...
const defaultBodyComponents = {
  Mention: ({ mention }) => {
    return /* @__PURE__ */ jsxRuntime.jsxs(CommentMention, { children: [
      core.MENTION_CHARACTER,
      mention.id
    ] });
  },
  Link: ({ href, children }) => {
    return /* @__PURE__ */ jsxRuntime.jsx(CommentLink, { href, children });
  }
};
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      Component,
      {
        ...
        children: body.content.map((block, index) => {
          switch (block.type) {
            case "paragraph":
              return /* @__PURE__ */ jsxRuntime.jsx("p", { style: { minHeight: "1lh" }, children: block.children.map((inline, index2) => {
                if (core.isCommentBodyMention(inline)) {
                  const { type: _, ...mention } = inline;
                  return mention.id ? /* @__PURE__ */ jsxRuntime.jsx(Mention, { mention }, index2) : null;
                }
                if (core.isCommentBodyLink(inline)) {
                  const href = core.sanitizeUrl(inline.url);
                  if (href === null) {
                    return /* @__PURE__ */ jsxRuntime.jsx("span", { children: inline.text ?? inline.url }, index2);
                  }
                  return /* @__PURE__ */ jsxRuntime.jsx(Link, { href, children: inline.text ?? inline.url }, index2);
                }
                let children = inline.text;
                if (inline.bold) {
                  children = /* @__PURE__ */ jsxRuntime.jsx("strong", { children }, index2);
                }
                if (inline.italic) {
                  children = /* @__PURE__ */ jsxRuntime.jsx("em", { children }, index2);
                }
                if (inline.strikethrough) {
                  children = /* @__PURE__ */ jsxRuntime.jsx("s", { children }, index2);
                }
                if (inline.code) {
                  children = /* @__PURE__ */ jsxRuntime.jsx("code", { children }, index2);
                }
