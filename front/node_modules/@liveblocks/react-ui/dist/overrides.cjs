...
const defaultOverrides = {
  ...
  COMMENT_REACTION_LIST: (list, emoji) => /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    list,
    " reacted with ",
    /* @__PURE__ */ jsxRuntime.jsx(Emoji.Emoji, { emoji })
  ] }),
  ...
  INBOX_NOTIFICATION_THREAD_COMMENTS_LIST: (list, room) => /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    list,
    " commented",
    room ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      " in ",
      room
    ] }) : /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: " in a thread" })
  ] }),
  INBOX_NOTIFICATION_THREAD_MENTION: (user, room) => /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    user,
    " mentioned you",
    room ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      " in ",
  ...
  INBOX_NOTIFICATION_TEXT_MENTION: (user, room) => /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    user,
    " mentioned you",
    room ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      " in ",
  ...
  HISTORY_VERSION_PREVIEW_AUTHORS_LIST: (list) => /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    "Edits from ",
    list
  ] }),
  ...
  AI_CHAT_MESSAGE_REASONING: (isStreaming, part) => isStreaming ? /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: "Reasoning\u2026" }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    "Reasoned",
    isDurationVisible(part.startedAt, part.endedAt) ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      " ",
      "for",
      " ",
  ...
  AI_CHAT_MESSAGE_RETRIEVAL: (isStreaming, part) => {
    if (part.kind === "knowledge") {
      return isStreaming ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        "Searching",
        " ",
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "lb-ai-chat-message-retrieval-query", children: part.query }),
        "\u2026"
      ...
      return isStreaming ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        "Searching the web",
        part.query ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          " ",
          "for",
          " ",
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "lb-ai-chat-message-retrieval-query", children: part.query })
...
function OverridesProvider({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(OverridesContext.Provider, { value: overrides, children });
}
