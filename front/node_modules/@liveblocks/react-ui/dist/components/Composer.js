...
function ComposerInsertEmojiEditorAction({
  ...
  return /* @__PURE__ */ jsx(EmojiPicker, { onEmojiSelect: insertText, onOpenChange: onPickerOpenChange, children: /* @__PURE__ */ jsx(Tooltip, { content: tooltipLabel ?? label, children: /* @__PURE__ */ jsx(EmojiPickerTrigger, { asChild: true, children: /* @__PURE__ */ jsx(
    Button,
    {
      className: cn("lb-composer-editor-action", className),
      onPointerDown: preventDefault,
