...
function ReachEndMarker({
  ...
  return /* @__PURE__ */ jsx("div", { ref: markerRef, style: { height: 0 } });
}
const InboxNotificationList = forwardRef(({ onReachEnd, children, className, ...props }, forwardedRef) => {
  return /* @__PURE__ */ jsxs(
    "ol",
    {
      ...
      ref: forwardedRef,
      children: [
        Children.map(children, (child, index) => /* @__PURE__ */ jsx("li", { className: "lb-inbox-notification-list-item", children: child }, index)),
