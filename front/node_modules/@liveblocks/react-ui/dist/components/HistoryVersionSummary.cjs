  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "lb-history-version-summary-authors", children: /* @__PURE__ */ jsxRuntime.jsx(
          List.List,
          {
            values: version.authors.map((author) => /* @__PURE__ */ jsxRuntime.jsx(User.User, { userId: author.id, replaceSelf: true }, author.id)),
