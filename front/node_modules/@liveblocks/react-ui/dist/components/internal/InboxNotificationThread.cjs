...
function InboxNotificationComment({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      ...props,
      children: [
        showHeader && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "lb-comment-header", children: /* @__PURE__ */ jsxRuntime.jsx(User.User, { className: "lb-comment-author", userId: comment.userId }) }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "lb-comment-content", children: comment.body ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          ...
          showReactions && comment.reactions.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "lb-comment-reactions", children: comment.reactions.map((reaction) => /* @__PURE__ */ jsxRuntime.jsx(
            Comment.CommentNonInteractiveReaction,
            {
              reaction,
              overrides: overrides$1,
              disabled: true
          ...
          showAttachments && comment.attachments.length > 0 ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "lb-comment-attachments", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "lb-attachments", children: comment.attachments.map((attachment) => /* @__PURE__ */ jsxRuntime.jsx(
            Comment.CommentNonInteractiveFileAttachment,
            {
              attachment,
              overrides: overrides$1,
