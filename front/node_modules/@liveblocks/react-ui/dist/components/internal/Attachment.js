...
function getAttachmentIconGlyph(mimeType) {
  if (mimeType === "application/zip" || mimeType === "application/gzip" || mimeType === "application/vnd.rar" || mimeType === "application/x-rar-compressed" || mimeType === "application/x-7z-compressed" || mimeType === "application/x-zip-compressed" || mimeType === "application/x-tar" || mimeType === "application/x-bzip" || mimeType === "application/x-bzip2") {
    return /* @__PURE__ */ jsx("path", { d: "M13 15h2v1h-1.5a.5.5 0 0 0 0 1H15v1h-1.5a.5.5 0 0 0 0 1H15v1h-1.5a.5.5 0 0 0 0 1h1a.5.5 0 0 0 .5-.5V20h1.5a.5.5 0 0 0 0-1H15v-1h1.5a.5.5 0 0 0 0-1H15v-1h1.5a.5.5 0 0 0 .5-.5V15a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2Z" });
  }
  if (mimeType.startsWith("text/") || mimeType.startsWith("font/") || mimeType.startsWith("application/")) {
    return /* @__PURE__ */ jsx("path", { d: "M10 16a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5Zm0 2a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 0 1h-8a.5.5 0 0 1-.5-.5Z" });
  }
  if (mimeType.startsWith("image/")) {
    return /* @__PURE__ */ jsx("path", { d: "M12 16h6a1 1 0 0 1 1 1v3l-1.293-1.293a1 1 0 0 0-1.414 0L14.09 20.91l-.464-.386a1 1 0 0 0-1.265-.013l-1.231.985A.995.995 0 0 1 11 21v-4a1 1 0 0 1 1-1Zm-2 1a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-6a2 2 0 0 1-2-2v-4Zm3 2a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" });
  }
  if (mimeType.startsWith("video/")) {
    return /* @__PURE__ */ jsx("path", { d: "M12 15.71a1 1 0 0 1 1.49-.872l4.96 2.79a1 1 0 0 1 0 1.744l-4.96 2.79A1 1 0 0 1 12 21.29v-5.58Z" });
  }
  if (mimeType.startsWith("audio/")) {
    return /* @__PURE__ */ jsx("path", { d: "M15 15a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 1 0v-7a.5.5 0 0 0-.5-.5Zm-2.5 2.5a.5.5 0 0 1 1 0v3a.5.5 0 0 1-1 0v-3Zm-2 1a.5.5 0 0 1 1 0v1a.5.5 0 0 1-1 0v-1Zm6-1a.5.5 0 0 1 1 0v3a.5.5 0 0 1-1 0v-3ZM19 16a.5.5 0 0 0-.5.5v5a.5.5 0 0 0 1 0v-5a.5.5 0 0 0-.5-.5Z" });
  }
  return null;
}
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        ...
        iconGlyph && /* @__PURE__ */ jsx("g", { className: "lb-attachment-icon-glyph", children: iconGlyph })
      ]
    }
  );
});
...
function AttachmentPreview({
  ...
  return /* @__PURE__ */ jsx(AttachmentFileIcon, { mimeType: attachment.mimeType });
}
function AttachmentName({
  ...
  return /* @__PURE__ */ jsxs("span", { className: "lb-attachment-name", title: attachment.name, children: [
    /* @__PURE__ */ jsx("span", { className: "lb-attachment-name-base", children: fileBaseName }),
    fileExtension && /* @__PURE__ */ jsx("span", { className: "lb-attachment-name-extension", children: fileExtension })
  ] });
}
...
function MediaAttachment({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "lb-attachment-preview", children: isUploading ? /* @__PURE__ */ jsx(SpinnerIcon, {}) : isError ? /* @__PURE__ */ jsx(WarningIcon, {}) : /* @__PURE__ */ jsx(
          AttachmentPreview,
          {
            attachment,
            allowMediaPreview,
        ...
        /* @__PURE__ */ jsxs("div", { className: "lb-attachment-details", children: [
          /* @__PURE__ */ jsx(AttachmentName, { attachment }),
          /* @__PURE__ */ jsx("span", { className: "lb-attachment-description", title: description, children: description })
        ] }),
        onDeleteClick && /* @__PURE__ */ jsx(Tooltip, { content: deleteLabel, children: /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
