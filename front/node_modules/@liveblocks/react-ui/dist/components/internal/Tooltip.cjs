...
function getShortcutKbdFromKeymap(keymap) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: keys.map((key, index) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("span", { children: key }, index);
  }) });
}
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Tooltip,
    {
      content: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        content,
        shortcutKbd && /* @__PURE__ */ jsxRuntime.jsx("kbd", { className: "lb-tooltip-shortcut", children: shortcutKbd })
      ] }),
      ...props,
      ref: forwardedRef,
      children
