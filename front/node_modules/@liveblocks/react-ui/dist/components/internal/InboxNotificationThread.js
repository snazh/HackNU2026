...
function InboxNotificationComment({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      ...props,
      children: [
        showHeader && /* @__PURE__ */ jsx("div", { className: "lb-comment-header", children: /* @__PURE__ */ jsx(User, { className: "lb-comment-author", userId: comment.userId }) }),
        /* @__PURE__ */ jsx("div", { className: "lb-comment-content", children: comment.body ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(
            CommentBody,
            {
          ...
          showReactions && comment.reactions.length > 0 && /* @__PURE__ */ jsx("div", { className: "lb-comment-reactions", children: comment.reactions.map((reaction) => /* @__PURE__ */ jsx(
          ...
          showAttachments && comment.attachments.length > 0 ? /* @__PURE__ */ jsx("div", { className: "lb-comment-attachments", children: /* @__PURE__ */ jsx("div", { className: "lb-attachments", children: comment.attachments.map((attachment) => /* @__PURE__ */ jsx(
