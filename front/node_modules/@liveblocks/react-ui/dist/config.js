...
function LiveblocksUiConfig({
  ...
  return /* @__PURE__ */ jsx(LiveblocksUiConfigContext.Provider, { value: liveblocksUiConfig, children: /* @__PURE__ */ jsx(OverridesProvider, { overrides, children: /* @__PURE__ */ jsx(ComponentsProvider, { components, children }) }) });
}
